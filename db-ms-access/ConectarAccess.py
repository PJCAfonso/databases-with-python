...
Código só funciona no Windows visto que é necessário instalar o driver
de conexão do Microsoft Access ou ter o Microsoft Access instalado no
computador.
...
Em caso de problemas na instalação com `pip install pyodbc` pode-se
utilizar pacote diponiblizado em https://www.lfd.uci.edu/~gohlke/pythonlibs/#pyodbc
"""
