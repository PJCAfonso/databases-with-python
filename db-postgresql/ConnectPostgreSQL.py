# -*- coding: utf-8 -*-
"""Exemplo de CRUD com Python, psycopg2 e PostgreSQL."""
...
class ConnectDB:
    ...
    def insert_rows(self, many_data):
        ...
        VALUES (%s, %s, %s);'''
        try:
            self.cur.executemany(query, many_data)
        except Exception as e:
            self.con.rollback()
...
if __name__ == '__main__':
    ...
    database.insert_rows(many_data=users_list)
    ...
    # Inserindo vários registros na tabela.
    database.insert_rows(many_data=users_tuple)
